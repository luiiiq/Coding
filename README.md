...
💻 Coding é um projeto web voltado para a venda de curso de programação, oferecendo uma experiência de usuário moderna, intuitiva e interativa. O objetivo é facilitar o acesso ao aprendizado de programação com layouts dinâmicos e responsivos, destacando os cursos e suas características.

🔹 Funcionalidades

Catálogo de cursos: Exibição de cursos com descrição, nível e preço.

Layout responsivo: Compatível com dispositivos móveis e desktops.

Animações e interações modernas: Cards animados, efeitos de hover e transições suaves.
